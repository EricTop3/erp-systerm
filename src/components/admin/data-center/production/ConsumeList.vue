    ...
    <div class="row">
      ...
      <div class="col-lg-10">
        ...
        <ol class="breadcrumb breadcrumbs">
          ...
          <li class="active"><a v-link="{ path: '/admin/dataCenter/production/consumeList'}"> 材料出库统计</a></li>
        ...
        <div class="page-header">
          <form class="form-inline">
            ...
            <a v-link="{ path: '/admin/dataCenter/production/consumeListDetail'}" class="btn btn-primary spanblocks fr mr10">明细</a>
          </form>
        </div>
        ...
        <table class="table table-striped table-border table-hover mt20" :data="onedata">
          ...
          <tr>
            <td>
              <span class="pr50">出库总量：{{onedata.amount}}</span>
              <span class="pr50">出库总额：{{onedata.price}}</span>
            </td>
          </tr>
          </tbody>
        </table>
...
//      获取数据列表
      getListData: function(page){
        var self = this
        var url = requestSystemUrl + '/backend-system/data-center/produce/consume-list'
        var data = {
...
//      获取单条数据
      getOneData: function(page){
        var self = this
        var url = requestSystemUrl + '/backend-system/data-center/produce/consume-list/total'
        var data = {
          start_time: self.searchData.start_time,
          end_time: self.searchData.end_time,
          item_code: self.searchData.item_code,
