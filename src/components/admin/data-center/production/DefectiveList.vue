    ...
    <div class="row">
      ...
      <div class="col-lg-10">
        ...
        <ol class="breadcrumb breadcrumbs">
          ...
          <li class="active"><a v-link="{ path: '/admin/dataCenter/production/defectiveList'}"> 生产入库单次品统计</a></li>
        </ol>
        <!-- 页头 -->
        <div class="page-header">
          <form class="form-inline">
            ...
            <a v-link="{ path: '/admin/dataCenter/production/defectiveListDetail'}" class="btn btn-primary spanblocks fr mr10">明细</a>
          </form>
        </div>
...
//      获取数据列表
      getListData: function(page){
        var self = this
        var url = requestSystemUrl + '/backend-system/data-center/produce/defective-list'
        var data = {
...
//      获取单条数据
      getOneData: function(page){
        var self = this
        var url = requestSystemUrl + '/backend-system/data-center/produce/defective-list/total'
        var data = {
          start_time: self.searchData.start_time,
          end_time: self.searchData.end_time,
          item_code: self.searchData.item_code,
