    ...
    <div class="row">
      ...
      <div class="col-lg-10">
        ...
        <ol class="breadcrumb breadcrumbs">
          ...
          <li class="active"><a v-link="{ path: '/admin/dataCenter/instock/allocateListDetail'}"> 调拨单明细</a></li>
          <li><a v-link="{ path: '/admin/dataCenter/instock/checkList'}"> 要货单统计</a></li>
...
//      获取数据列表
      getListData: function(page){
        var self = this
        var url = requestSystemUrl + '/backend-system/data-center/stock/allocate-list/details'
        var data = {
