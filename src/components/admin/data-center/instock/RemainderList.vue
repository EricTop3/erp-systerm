    ...
    <div class="row">
      ...
      <div class="col-lg-10">
        ...
        <ol class="breadcrumb breadcrumbs">
          ...
          <li class="active"><a v-link="{ path: '/admin/dataCenter/instock/remainderList'}"> 存货总账</a></li>
        ...
        <div class="page-header">
          <form class="form-inline">
            ...
            <a v-link="{ path: '/admin/dataCenter/instock/remainderListDetail'}"
               class="btn btn-primary spanblocks fr mr10">明细</a>
          </form>
        </div>
...
//      获取数据列表
      getListData: function (page) {
        var self = this
        var url = requestSystemUrl + '/backend-system/data-center/stock/log-collect-list'
        var data = {
...
//      获取单条数据
      getOneData: function (page) {
        var self = this
        var url = requestSystemUrl + '/backend-system/data-center/stock/log-collect-list/total'
        var data = {
          start_time: self.searchData.start_time,
          end_time: self.searchData.end_time,
          item_code: self.searchData.item_code,
