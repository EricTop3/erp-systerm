    ...
    <div class="row">
      ...
      <div class="col-lg-10">
        ...
        <ol class="breadcrumb breadcrumbs">
          ...
          <li class="active"><a v-link="{ path: '/admin/dataCenter/sale/bankList'}"> 收银账号统计表</a></li>
        </ol>
        <!-- 页头 -->
        <div class="page-header">
          <form class="form-inline">
            ...
            <a v-link="{ path: '/admin/dataCenter/sale/bankListDetail'}" class="btn btn-primary spanblocks fr mr10">明细</a>
          </form>
        </div>
        ...
        <table class="table table-striped table-border table-hover mt20" :data="onedata">
          ...
          <tr>
            <td>
              <span class="pr50">收银总额：{{onedata.total_sum}}</span>
              <span class="pr50">收银总笔数：{{onedata.count}}</span>
            </td>
          </tr>
          </tbody>
        </table>
...
//      获取数据列表
      getListData: function (page) {
        var self = this
        var url = requestSystemUrl + '/backend-system/data-center/order/bank-list'
        var data = {
...
//      获取单条数据
      getOneData: function (page) {
        var self = this
        var url = requestSystemUrl + '/backend-system/data-center/order/bank-list/total'
        var data = {
          start_time: self.searchData.start_time,
          end_time: self.searchData.end_time,
          store_id: self.searchData.store_id
