<template>
  <div @click.stop="" @touchstart.stop="" class="calendar" v-show="show" :style="{'left':x+'px','top':y+'px'}"
    ...
    <div class="calendar-tools">
      <i class="glyphicon glyphicon-chevron-left float left" @click="prev" @touchstart="prev"></i>
      <i class="glyphicon glyphicon-chevron-right float right" @click="next" @touchstart="next"></i>
